    ...
    popup.innerHTML = `
        <div class="space-y-4 p-1">
            <div>
                ...
                <ul class="space-y-1">
                    <li class="flex items-center text-sm text-slate-700 px-3 py-1"><svg class="w-4 h-4 text-blue-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg><span><span class="font-bold text-slate-800">"표시해줘"</span> : 지도에 위치를 찍어줍니다.</span></li>
